        ...
        <div>
          ...
          <div>
            <label className="radio">
                <input type="radio" name="unit" id="celsius"
                 value={TemperaturUnits.Celsius} checked={unit === TemperaturUnits.Celsius}  onChange={changeHandler} />
          ...
          <div>
            <label className="radio">
                ...
                value={TemperaturUnits.Ferenheit} id="farenheit" checked={unit === TemperaturUnits.Ferenheit} onChange={changeHandler} />
